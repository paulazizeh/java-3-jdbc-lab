package edu.cscc.framework;

import edu.cscc.framework.exceptions.RoutingException;

import java.lang.reflect.Method;

/**
 * This class is responsible for routing {@link Request}s to the appropriate
 * controller and controller method. It is a edu.cscc.mvc.framework object and should not be
 * called directly.
 */
public class RequestRouter {
    ...
    /**
     * This constructor is used by the edu.cscc.mvc.framework and should not be invoked
     * directly.
     * @param context
     */
    ...
    private String getResourceClass(Request request) {
        return "edu.cscc." + request.getResource() + "Controller";
    }
}
